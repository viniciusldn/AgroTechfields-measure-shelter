...
public class IslandController {
  ...
  @POST
  public void salvar(IslandCreateDTO carroDTO){
    islandService.salvar(carroDTO);
  }

  @PATCH
  @Path("/{id}")
  public void atualizar(@PathParam("id") Long id, IslandUpdateDTO carroDTO){
    islandService.atualizar(carroDTO, id);
  }
